...
public class PersonalAccountTest
{
    ...
    @Test
    @DisplayName("Выход пользователем при авторизации путем помещения accessTocken в local storage")
    @Description("Выход пользователем при авторизации путем помещения accessTocken в local storage")
    ...
    @Test
    @DisplayName("Выход пользователем при авторизации через Login Page")
    @Description("Выход пользователем при авторизации через Login Page")
    public void checkExitFullSteps()
    {
        LoginPage objEnterToAccount = new LoginPage(driver);
